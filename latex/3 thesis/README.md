...
-----------
  ...
  3. If not, make sure you have all the require packages installed (see swsLeipzig.cls).
  4. If everything works like it should, you should not be forced to change anything in swsLeipzig.cls at all.
