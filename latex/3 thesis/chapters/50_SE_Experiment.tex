...
\begin{table}[h]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|}
        ...
        \hline
        DeepSeek-V3 & 0.773 & 0.779 & 0.766 & 0.678 & 0.797 & 0.590 \\
        Gemini-2.5-Flash & 0.770 & 0.814 & 0.731 & 0.379 & 0.744 & 0.254 \\
        GPT-4o-mini (2024-07-18) & 0.683 & 0.788 & 0.603 & 0.478 & 0.769 & 0.347 \\
        GPT-4o-mini (most recent) & 0.681 & 0.744 & 0.631 & 0.480 & 0.743 & 0.353 \\
        Qwen-235b-a22b & 0.596 & 0.773 & 0.485 & 0.0 & 0.0 & 0.0 \\
        Qwen-32b & 0.592 & 0.803 & 0.469 & 0.0 & 0.0 & 0.0 \\
        \hline
    \end{tabular}
...
The best scored F1-Score (0.770) did score the gemini-2.5-flash model within the Ciri configuration, followed by the DeepSeek-V3 model with an F1-Score of 0.773. Our RAG configurations did overall a comparable performance with the original Ciri results, but not matching results with most recent models. A F1-score 0.6929 for one sparse configuration with the most recent version of gpt-4o-mini. We also came close to this results with a dense 4R-architecture and the \textit{infly/inf-retriever-v1-1.5b} embedder (0.6825). 
