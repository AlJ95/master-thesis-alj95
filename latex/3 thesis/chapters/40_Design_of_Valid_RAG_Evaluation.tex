...
\section{Tracing}
% Use Langfuse for it
% MLFlow is not compatible with Haystack yet.
...
% Warum nicht full-mode mlflow mit mlflow.genai (s. Docs)?
% Überall steht dran Experimental: This function may change or be removed in a future release without warning.
% Es gibt kein LLM-as-a-Judge für Retrieval. Es wird Ground-Truth Doc Ids benötigt, welches wie bereits besprochen ungünstig für schnelles RAG Entwickeln ist. 
% GenAI ist nicht dafür ausgelegt den Blueprint Ansatz durchzuführen sondern versucht alles out-of-the-box anzubieten.
...
% - Answer Builder?
% - From Python vs From Config
% - Matrix Notation
% - Langfuse Tracing
%   -> How to come from bad component to tracing (Scores, Tags)
