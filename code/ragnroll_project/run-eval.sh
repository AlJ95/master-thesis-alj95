# environment variables                                                                                                                                     # derived from python -m ragnroll run-evaluations ./configs/baselines/llm_config.yaml ./data/processed/config_val/evaluation_data.json ./data/processed/config_val/corpus ./output.csv --no-baselines --test-size=30
